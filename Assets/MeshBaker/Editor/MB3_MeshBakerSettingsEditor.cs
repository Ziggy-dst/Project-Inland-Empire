...
namespace DigitalOpus.MB.MBEditor
{
    ...
    public class MB_MeshBakerSettingsEditor
    {
        private static GUIContent
            ...
            gc_lightmappingOptionGUIContent = new GUIContent("Lightmapping UVs", "preserve current lightmapping: Use this if all source objects are lightmapped and you want to preserve it. All source objects must use the same lightmap.\n\n" +
