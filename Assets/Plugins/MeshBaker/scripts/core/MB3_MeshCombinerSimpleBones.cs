...
namespace DigitalOpus.MB.Core
{
    ...
    public partial class MB3_MeshCombinerSingle : MB3_MeshCombiner
    {
        public class MB3_MeshCombinerSimpleBones
        {
            ...
            public static void AddBonesToNewBonesArrayAndAdjustBWIndexes(Matrix4x4[] bindPoses, MB_DynamicGameObject dgo, Renderer r, int vertsIdx,
            ...
            public static void UpdateBWIndexes(MB_DynamicGameObject dgo, Renderer r,
                                                             Transform[] rendererBones, Transform[] bonesBuffer, BoneWeight[] boneWeights, MeshChannelsCache meshChannelCache)
            {
